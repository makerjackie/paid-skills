...
const COPY_OVERRIDES: Record<string, Partial<HistoryVideoCopy>> = {
  ...
  'programming-youtubers-race': {
    ...
    coverHeadline: '编程 YouTuber / 谁在爆发？',
  ...
  'chinese-creators-youtube-race': {
    platformTitle: '中文 YouTuber 订阅排名：老高称霸，谁在挑战？',
    coverKicker: '2015 → 2026 · 中文 YouTuber 订阅排名',
    coverHeadline: '中文 YouTuber / 谁在领跑？',
    coverSubline: '老高与小茉、李永乐、钟文泽、阿滴的订阅争夺战',
    coverBadge: '2015-2026 · 12 年订阅排名',
    hook: '中文 YouTube 订阅排名，12 年里谁增长最快？',
    intro: '从 2015 到 2026，看老高与小茉、李永乐老师、钟文泽、阿滴英文等 12 个中文 YouTube 频道订阅排名的演变。',
    insight: '故事型、知识型、科技型、教育型内容在中文 YouTube 上各自找到了自己的观众群。',
    cta: '去 shapeof.world 看更完整的互动数据。',
  },
  'ai-products-mau-race': {
    platformTitle: 'AI 产品月活排名：ChatGPT 一骑绝尘，谁能追得上？',
    coverKicker: '2022 → 2026 · AI 产品月活用户',
    coverHeadline: 'AI 产品月活 / 谁在领跑？',
  ...
  'github-stars-race': {
    platformTitle: 'GitHub Star 排名：React、Vue、TensorFlow 的开源人气之王',
    coverKicker: '2014 → 2026 · GitHub Stars',
    coverHeadline: 'GitHub Stars / React vs Vue vs TensorFlow',
    coverSubline: 'React、Vue、TensorFlow 的 13 年 Star 争夺战',
    coverBadge: '2014-2026 · 13 年 Star 排名',
    hook: '13 年里，GitHub 上最火的开源项目 Star 排名经历了怎样的洗牌？',
    intro: '从 2014 到 2026，React、Vue、TensorFlow、VS Code 等 14 个顶级开源项目，Star 数的排名格局经历了多次反转。',
    insight: '开源人气排名背后是技术浪潮的更迭——从前端框架争霸到 AI 框架崛起。',
    cta: '去 shapeof.world 看更完整的互动数据。',
  },
};
